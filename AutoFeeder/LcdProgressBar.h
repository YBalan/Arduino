...
#define LCD_PROGRESS_BAR_TRACE_NAME "LcdProgressBar: "
...
namespace Helpers
{
  ...
  private: //virtuals
    ...
    { 
      if(_lcd != 0)
      {
        ...
        {
          S_PRINT2(LCD_PROGRESS_BAR_TRACE_NAME, "Init");
        ...
        {
          S_PRINT2(LCD_PROGRESS_BAR_TRACE_NAME, "Clear");
  ...
  private:
    ...
    {
      S_PRINT3(LCD_PROGRESS_BAR_TRACE_NAME, value, "%");
